...
const translations = {
  en: {
    ...
    'glossary.all': 'All',
    'sim.title': 'Interactive Scenario Simulator',
    'sim.subtitle': 'Explore real-world election edge cases. What happens if...',
    'sim.start': 'Simulate',
    'sim.missed_registration.title': 'Missed Registration Deadline',
    'sim.missed_registration.desc': 'What happens if you miss the voter registration deadline?',
    'sim.name_missing.title': 'Name Not in Voter List',
    'sim.name_missing.desc': 'You have a Voter ID, but your name is missing from the list at the booth.',
    'sim.changed_residence.title': 'Changed Residence',
    'sim.changed_residence.desc': 'You moved to a new city or state and need to update your voter status.',
  ...
  hi: {
    ...
    'glossary.all': 'सभी',
    'sim.title': 'इंटरएक्टिव परिदृश्य सिम्युलेटर',
    'sim.subtitle': 'वास्तविक चुनाव के किनारे के मामलों का अन्वेषण करें। क्या होगा अगर...',
    'sim.start': 'अनुकरण करें',
    'sim.missed_registration.title': 'पंजीकरण की समय सीमा चूक गई',
    'sim.missed_registration.desc': 'यदि आप मतदाता पंजीकरण की समय सीमा चूक जाते हैं तो क्या होगा?',
    'sim.name_missing.title': 'मतदाता सूची में नाम नहीं है',
    'sim.name_missing.desc': 'आपके पास मतदाता पहचान पत्र है, लेकिन बूथ पर सूची से आपका नाम गायब है।',
    'sim.changed_residence.title': 'निवास बदल गया',
    'sim.changed_residence.desc': 'आप एक नए शहर या राज्य में चले गए हैं और अपने मतदाता विवरण को अपडेट करने की आवश्यकता है।',
